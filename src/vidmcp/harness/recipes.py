...
RECIPES: dict[str, dict[str, Any]] = {
    ...
    "talking_head_reels": {
        "name": "talking_head_reels",
        "description": "Vertical talk-head polish for Reels/Shorts/TikTok (9:16)",
        "subject_prompt": "person",
        "creator_pipeline": True,
        "bg_mode": "none",
        "preset": "reels_9x16",
    ...
    "talking_head_space": {
        "name": "talking_head_space",
        "description": "Talk-head with space plate BG, denoise, BGM, captions",
        "subject_prompt": "person",
        "creator_pipeline": True,
        "bg_mode": "space",
        "preset": "youtube_16x9",
    ...
    "talking_head_tight": {
        "name": "talking_head_tight",
        "description": "Polish + smart-cut hesitations/dead air for a tight cut",
        "subject_prompt": "person",
        "creator_pipeline": True,
        "bg_mode": "none",
        "preset": "youtube_16x9",
    ...
    "talking_head_infographics": {
        "name": "talking_head_infographics",
        "description": "Polish with speech-locked keyword/number callout cards",
        "subject_prompt": "person",
        "creator_pipeline": True,
        "bg_mode": "none",
        "preset": "youtube_16x9",
